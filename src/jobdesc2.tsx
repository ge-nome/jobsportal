                        ...
                        <form action="" className="py-7 px-5 bg-white grid gap-6 rounded">
                            ...
                            <div className="grid gap-3 mb-10 text-[#002160]">
                                ...
                                <div className="h-[70px] flex flex-wrap gap-4 ">
                                    ...
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Overtime pay</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Shift bonus</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Shift allowance</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Joining bonus</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Other bonus</p>
                                </div>
                            </div>
                            <div className="grid gap-3 mb-10 text-[#002160]">
                                <div className="grid">
                                    <label htmlFor="">Benefits Pay</label>
                                </div>
                                <div className="h-[70px] flex flex-wrap gap-4 ">
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Health insurance</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Providient Fund</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Cell phone reimbursement</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Paid sick time</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Work from home</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Paid time off</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Food provided</p>
                                    <p className="p-2 px-3 rounded-full border border-[#002160] border-2 text-[#002160] cursor-pointer">+ Other</p>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between">
                                <button onClick={(e)=>{e.preventDefault(); navigate('/job2')}}>Back</button>
                                <div className="flex gap-3">
                                    <button className="border-1 border-[#0084BF] text-black px-5 py-2 rounded font-bold">Preview</button>
                                    <button className="bg-[#6c757d] text-white px-5 py-2 rounded cursor-pointer" onClick={(e)=>{e.preventDefault(); navigate('/')}}>Next</button>
                                </div>
                            </div>
                        </form>
                    </div>
